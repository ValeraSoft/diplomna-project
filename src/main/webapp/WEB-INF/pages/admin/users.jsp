<%@ page import="com.spring_final.model.Authority" %>
        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
            ...
            <tr scope="row">
                ...
                <td>${user.contact}</td>
                <td>
                    <c:set var="isAdmin" value="${user.authorities.size() gt 1}" />
                    <c:if test="${isAdmin}">
                        <a href="setAdmin?id=${user.id}&admin=true" class="btn btn-primary bg-dark text-white">
                            Unset admin
                        </a>
                    </c:if>
                    <c:if test="${not isAdmin}">
                        <a href="setAdmin?id=${user.id}&admin=false" class="btn btn-primary bg-dark text-white">
                            Set admin
                        </a>
                    </c:if>
                </td>
